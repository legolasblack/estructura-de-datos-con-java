 ...
 * Interfaces
 * 
 * En este archivo implementamos una clase dog que define pocos atributos de un perro
 * y una interfaz que define a los canes llamada caninos 
 * las dos coverjen en una clase llamada mascota de esta manera realizando una implementacion 
 * de metodos abstractos 
 * 
 * las interfaces pueden ser multiplemente heredadas por una clase 
 * las interfaces al igual que las clases abstractas no pueden ser instanciadas 
 * las interfaces sirven unicamente para definir de manera abstracta las clases hijo
 */
public class Interfaces {

    public static void main(String[] args) {
        Mascota perro=new Mascota("bull terrier ingles", "blanco", 2836782 , "loki");
        perro.aullar();
        perro.ladrar();
    }
...
class Mascota extends Dog implements Canino {
int id;
String name;

public Mascota(String Raza, String Color, int id_serie, String Name ){
    super(Raza, Color);
    this.id=id_serie;
    this.name=Name;
}
